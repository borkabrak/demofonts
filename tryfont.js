...
var select = function(selector){
    // return a single element determined by the given selector
...
var tid = setInterval( function () {
    ...
    select("form#addfont").onsubmit = function (){
    ...
    select("[type=reset]").onclick = function(event){
        select("#samples").innerHTML = "";
    };
